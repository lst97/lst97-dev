...
import NonBlockingSpinner from './NonBlockingSpinner'
    ...
    >
      <div className="flex items-start">
        ...
        <div>
          ...
          >
            The browser is using its main thread to decode and process your images, which may
            temporarily cause the UI to lag or freeze during processing.
          </p>
