...
const Welcome = () => {
  return (
    <Dashboard>
      <div className="lg:p-8 sm:p-2 mt-16 overflow-x-hidden no-scrollbar">
        <AIChatBot />
        <div className="flex flex-col gap-32">
          <Introduction />
          <div className="flex flex-col md:flex-row gap-4 items-center justify-center text-gray-500 dark:text-gray-400 text-center text-xl font-mono tracking-widest leading-loose text-shadow-lg border-2 border-gray-500 dark:border-gray-400 p-4 rounded-lg bg-amber-100 shadow-md mx-4 md:mx-8 lg:mx-16">
