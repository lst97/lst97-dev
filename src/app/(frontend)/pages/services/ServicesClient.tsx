...
const freelancerAdvantages: FreelancerAdvantage[] = [
  ...
  },
  {
    ...
    description: (
      <>
        I&apos;m <span className="pixel-underline">passionate about web development</span> and
        committed to delivering <span className="pixel-underline">exceptional results</span> for
        every client.
      </>
    ),
  },
...
// Content component that might use useSearchParams
const ServicesContent = () => {
  ...
  const { form, isSending, isSuccess, message, handleTurnstileVerify } =
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full min-h-screen flex flex-col bg-transparent">
        <main className="relative flex-grow w-full max-w-[1800px] mx-auto px-4 sm:px-6 md:px-12 lg:px-20 xl:px-32 py-4 sm:py-6 md:py-8 mt-[100px] sm:mt-[120px] md:mt-[140px] lg:mt-[180px] bg-transparent">
          ...
          <ContactSection>
            ...
            <div className="max-w-6xl mx-auto px-8">
              <ContactForm
                form={form as unknown as TanStackFormProps}
                isSuccess={isSuccess}
                isSending={isSending}
        ...
        <AnimatePresence>
          {isProjectShowcaseOpen && selectedProject && (
            <ProjectShowcaseDialog
              open={isProjectShowcaseOpen}
              onClose={() => setIsProjectShowcaseOpen(false)}
            ...
            >
              ...
              {selectedProject.logoDescription && (
